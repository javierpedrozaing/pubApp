...
$.widget( "ui.autocomplete", {
	...
	_renderMenu: function( div, items ) {
		...
		$.each( items, function( index, item ) {
			that._renderItemData( div, item );
		});
	},

	_renderItemData: function( div, item ) {
		return this._renderItem( div, item ).data( "ui-autocomplete-item", item );
	},

	_renderItem: function( div, item ) {
		return $( "<p>" ).text( item.label ).appendTo( div );
	},
